<div class="container px-5 my-5">
    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
        ...
        <div class="mb-3">
            <label class="form-label" for="luasM2">Luas m2</label>
        ...
        <div class="mb-3">
            <label class="form-label" for="pemilikHak">Pemilik Hak</label>
        ...
        <div class="mb-3">
            <label class="form-label" for="penerimaHak">Penerima Hak</label>
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="tanggalMasuk" type="text" placeholder="Tanggal Masuk" data-sb-validations="required" />
